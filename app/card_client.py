...
class CardApiClient:
    # core-bancario-mock has no auth of its own (unlike renegotiation-service, which sits behind
    # PlatformMiddleware) - these are direct, unauthenticated internal calls. No service token is
    # created or attached here.
